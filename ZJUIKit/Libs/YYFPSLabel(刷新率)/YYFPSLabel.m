...
//        NSLog(@"%@", sender);
        ...
        if (sender.state == UIGestureRecognizerStateEnded) {
            ...
            [UIView animateWithDuration:0.2 animations:^{
                ...
                weakSelf.zj_originX = (weakSelf.zj_originX - kScreenWidth / 2) > 0 ? (kScreenWidth - weakSelf.zj_width - 20) : 20;
                weakSelf.zj_originY = weakSelf.zj_originY > 80 ? weakSelf.zj_originY : 80;
            }];
        }
