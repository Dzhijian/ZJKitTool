...
@implementation UIDevice (ZJHelperKitUIKit)
...
+ (NSString *)zj_devicePlatformString {
    NSString *platform = [self zj_devicePlatform];
    // iPhone
...
+ (BOOL)zj_isiPad {
    return [[[self zj_devicePlatform] substringToIndex:4] isEqualToString:@"iPad"];
}

+ (BOOL)zj_isiPhone {
    return [[[self zj_devicePlatform] substringToIndex:6] isEqualToString:@"iPhone"];
}

+ (BOOL)zj_isiPod {
    return [[[self zj_devicePlatform] substringToIndex:4] isEqualToString:@"iPod"];
}

+ (BOOL)zj_isSimulator {
    return [[self zj_devicePlatform] isEqualToString:@"i386"]
    || [[self zj_devicePlatform] isEqualToString:@"x86_64"];
}
